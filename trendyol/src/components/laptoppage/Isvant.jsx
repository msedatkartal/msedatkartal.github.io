...
function Isvant() {
    ...
    return (
        <>
            <div className="altun">
                <img src="img/laptop/isvant.jpeg" alt="" />
                <div className="title">
                    <p>ISVANT TEKNOLOJİ <span>9</span></p>
            ...
            <div className="threelaptop d-flex">
                {
                    cards?.map((card,i) => {
                        return (
                            ...
                            <div key={i} className="card me-3 mb-3 kart" style={{ maxWidth: " 231px", height: "110px", overflow: "hidden" }}>
